...
public enum ResponseStatusEnum {
    ...
    LESS_THAN_MINIMUM_WITHDRAW(1006, "الحد الأدنى للسحب هو 20"),
    ...
    CANNOT_JOIN_YOURSELF(3013, "لا يمكنك الانضمام إلى فريقك الخاص"),
    THIS_NOT_REAL_TEAM(3014, "لم يتم إنشاء الفريق الذي تريد الانضمام إليه"),
