package io.dubai.utils;

import io.dubai.entity.ColumnEntity;
import io.dubai.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.howard" : mainPath;
		...
		map.put("type", config.getString("type" ));
	...
	public static String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains("list.html.vm" )) {
			return "main" + File.separator + "resources" + File.separator + "templates" + File.separator
					+ "modules" + File.separator + moduleName + File.separator + StringUtils.uncapitalize(className) + ".html";
		}

		if (template.contains("list.js.vm" )) {
			return "main" + File.separator + "resources" + File.separator + "statics" + File.separator + "js" + File.separator
					+ "modules" + File.separator + moduleName + File.separator + StringUtils.uncapitalize(className) + ".js";
		}

		if (template.contains("menu.sql.vm" )) {
			return StringUtils.uncapitalize(className) + "_menu.sql";
		}
