$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [			
            { label: '日志ID', name: 'logId', width: 30, key: true },
			{ label: '任务ID', name: 'jobId', width: 30},
			{ label: 'bean名称', name: 'beanName', width: 80 },
			{ label: '参数', name: 'params', width: 200 },
			...
			{ label: '耗时(单位：毫秒)', name: 'times', width: 30 },
